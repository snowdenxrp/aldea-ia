...
for(const token of ["activityToolGroup","parts.axe","parts.hammer","parts.hoe","parts.rod","parts.crop"]) assert.ok(source.includes(token),"faltó herramienta visual: "+token);
