...
assert.ok(content.includes('activity==="gathering"'));
assert.ok(content.includes('activity==="fishing"'));
assert.ok(content.includes('activity==="eating"'));
assert.ok(content.includes('activity==="drinking"'));
assert.ok(content.includes('userData.animationActivity'));
