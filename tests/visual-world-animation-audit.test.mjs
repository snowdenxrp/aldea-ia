...
for(const token of ["activityToolGroup","parts.axe","parts.hammer","parts.hoe","parts.rod","crop:new THREE.Group"]) assert.ok(source.includes(token),"faltó herramienta visual: "+token);
