...
assert.equal(squad.reports.length,6);
assert.deepEqual(squad.reports.map(r=>r.assistant),["VisualAgent","ExplorerAgent","BehaviorAgent","EcosystemAgent","SocietyAgent","AuditAgent"]);
