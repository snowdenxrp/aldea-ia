...
const ACTIVITY_ROUTINES = {
  explore_area: [{name:"approach",hours:0},{name:"inspect",hours:.18},{name:"discover",hours:.12}],
  gather_wood: [{name:"approach",hours:0},{name:"inspect",hours:.08},{name:"collect",hours:.2}],
  gather_stone: [{name:"approach",hours:0},{name:"inspect",hours:.08},{name:"collect",hours:.2}],
  catch_fish: [{name:"approach",hours:0},{name:"cast",hours:.12},{name:"wait",hours:.18}],
  ...
  socialize: [{name:"approach",hours:0},{name:"talk",hours:.3}],
  share_knowledge: [{name:"approach",hours:0},{name:"teach",hours:.32}],
  cooperate: [{name:"approach",hours:0},{name:"work",hours:.35}],
  trade: [{name:"approach",hours:0},{name:"exchange",hours:.25}]
};
function beginActivityRoutine(agent,intent){
  ...
  agent.activitySequence={intentName:intent.name,phaseIndex:0,phase:phases[0].name,remainingHours:Number(phases[0].hours)||0,completedPhases:[]};
}
function advanceActivityRoutine(agent,hours){
  ...
  if(!phases){agent.activitySequence=null;return false;}
