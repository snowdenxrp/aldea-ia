...
function bridge(scene,x,z){const g=new THREE.Group(),d=B(4.6,.22,2.6,0x7b5739);d.position.y=.12;g.add(d);for(const sx of [-2,-.65,.65,2])for(const sz of [-1.18,1.18]){const p=B(.11,.8,.11,0x553a29);p.position.set(sx,.48,sz);g.add(p)}for(const sz of [-1.18,1.18]){const r=B(4.35,.1,.1,0x553a29);r.position.set(0,.83,sz);g.add(r)}g.position.set(x,0,z);scene.add(g);}
